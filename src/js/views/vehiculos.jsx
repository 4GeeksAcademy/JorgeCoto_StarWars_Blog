    ...
    <>
      <div className="mt-5">
        ...
        <div className="d-flex justify-content-end me-4">
          <a className=" fs-1 arrow-l m-2" onClick={handlePrevClick}>
            <i class="fas fa-arrow-left"></i>
          </a>
          <a className="fs-1 arrow-r m-2" onClick={handleNextClick}>
              ...
              <div className="flip-card-inner">
                ...
                <div className="flip-card-back">
                  ...
                  <p className="first-desc">
                    <strong>Velocity:</strong> {card.max_atmosphering_speed}
                  </p>
                  <p className="second-desc">
                    <strong>Tripulation:</strong> {card.passengers}
                  </p>
                  <div className="d-flex justify-content-evenly align-items-end">
                    <Link
                      to={"/vehiculo/" + card.uid}
                    ...
                    <a
                      className="fs-2 like"
                      onClick={() => handleFavoritoClick(card)}
                    >
