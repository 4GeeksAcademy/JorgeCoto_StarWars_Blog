...
<div className='mt-5'>
      ...
      <div className="d-flex justify-content-end me-4">
        <a className=' fs-1 arrow-l m-2' onClick={handlePrevClick}><i class="fas fa-arrow-left"></i></a>
        <a className='fs-1 arrow-r m-2' onClick={handleNextClick}><i class="fas fa-arrow-right"></i></a>
      </div>
          ...
          <div className="flip-card d-flex m-4" key={card.uid}>
            <div className="flip-card-inner">
              ...
              <div className="flip-card-back">
                ...
                <a className="fs-2 like" onClick={() => handleFavoritoClick(card)}><i class="fas fa-heart fs-3"></i></a>
                </div>
              </div>
            </div>
          </div>
